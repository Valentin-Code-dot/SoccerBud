...
/* harmony import */ var _components_filter__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_filter__WEBPACK_IMPORTED_MODULE_1__);
...
var filterTab = document.querySelectorAll('.filter__wrapper');
var filterBtn = document.querySelector('.filter-cards__btn');
var filterToggle = document.querySelector('.filter__container');
var filterClose = document.querySelector('.filter__btn--close');
filterTab.forEach(function (filterTab) {
  filterTab.addEventListener('click', function (e) {
    if (e.target.classList.contains('filter__name')) {
      e.target.classList.toggle('filter__name--active');
      e.target.nextElementSibling.classList.toggle('filter__box--hidden');
    }
  });
});
filterBtn === null || filterBtn === void 0 ? void 0 : filterBtn.addEventListener('click', function (e) {
  filterToggle === null || filterToggle === void 0 ? void 0 : filterToggle.classList.toggle('filter__container--active');
  enableScroll();
});
filterClose === null || filterClose === void 0 ? void 0 : filterClose.addEventListener('click', function (e) {
  filterToggle === null || filterToggle === void 0 ? void 0 : filterToggle.classList.remove('filter__container--active');
  enableScroll();
});
...
var popularSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.popular__swiper', {
  // Default parameters
  slidesPerView: 4,
  spaceBetween: 10,
  scrollbar: {
...
var SingleSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.single-reviews__swiper', {
  // Default parameters
  slidesPerView: 2.4,
  autoplay: {
    delay: 2000
...
var heroSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero__swiper', {
  // Default parameters
  slidesPerView: 2.4,
  spaceBetween: 10
});
var tutorialsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.tutorials__swiper', {
  // Default parameters
  slidesPerView: 4,
  spaceBetween: 10,
  scrollbar: {
...
(function () {
  ...
  var hideHero = (_document6 = document) === null || _document6 === void 0 ? void 0 : _document6.querySelector('.hero-hide');
  var hideSponsors = (_document7 = document) === null || _document7 === void 0 ? void 0 : _document7.querySelector('.sponsors-hide');
  burger === null || burger === void 0 ? void 0 : burger.addEventListener('click', function (e) {
    ...
    hideHero === null || hideHero === void 0 ? void 0 : hideHero.classList.toggle('hero-hide-toggle');
    hideSponsors === null || hideSponsors === void 0 ? void 0 : hideSponsors.classList.toggle('sponsors-hide-toggle');
  ...
  menuItems === null || menuItems === void 0 ? void 0 : menuItems.forEach(function (el) {
    el.addEventListener('click', function () {
      ...
      burger.classList.remove('burger--active');
      menu.classList.remove('menu--active');
      hideHero.classList.remove('hero-hide-toggle');
      hideSponsors.classList.remove('sponsors-hide-toggle');
      (0,_functions_enable_scroll__WEBPACK_IMPORTED_MODULE_1__.enableScroll)();
    });
  });
})();
